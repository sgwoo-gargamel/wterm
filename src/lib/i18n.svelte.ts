...
const ko = {
	...
	'reason.handshake-timeout': '수신 응답이 없습니다. 타겟에서 rb 또는 loady를 실행했는지 확인하세요',
...
const en: Record<MessageKey, string> = {
	...
	'ymodem.waiting': 'Waiting for receiver…',
	'ymodem.waitingHint': 'rb or loady must be running on the target',
	'ymodem.sending': 'Sending…',
	'ymodem.done': 'Transfer complete',
	'ymodem.failed': 'Transfer failed',
	...
	'reason.handshake-timeout': 'No response from the receiver. Check that rb or loady is running on the target',
